...
class City(functions.Sprite):
    def __init__(self, shape, color, x, y):
        functions.Sprite.__init__(self, shape, color, x, y)
...
class PlayerMissile(functions.Sprite):
    def __init__(self, shape, color, x, y):
        functions.Sprite.__init__(self, shape, color, x, y)
        self.speed = 5
        self.state = "ready"
...
class EnemyMissile(functions.Sprite):
    def __init__(self, shape, color, x, y):
        functions.Sprite.__init__(self, shape, color, x, y)
        self.dx = 0
        self.dy = 0
...
# Create Labels
status_label = functions.Label("Missile Command  \nLevel: {}  \nScore: {}  \nCities: {}  \nSilos: {}  \nPlayer Missiles: {}  \nEnemy Missiles: {}", "white", -390, 160)
